    ...
    <div class="container px-4 pt-5" id="featured-3">
        ...
        <div class="row g-4 py-5 row-cols-1 row-cols-lg-3">
            ...
            <div class="feature col">
                ...
                <h3 class="fs-2">Angsuran Pinjaman</h3>
                <p>Anggota KPN SEGAR dapat melakukan angsuran peminjaman</p>
            ...
            <div class="feature col">
                ...
                <h3 class="fs-2">Mendapatkan Penawaran menarik</h3>
                <p>Anggota KPN SEGAR Mendapatkan Penawaran harga Yang Menarik</p>
