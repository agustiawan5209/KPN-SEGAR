                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="hidden" value="4" name="jenis_asets_id" id="validationTooltip02"
                                        class="form-control" required value="{{old('jenis_asets_id')}}">
                                    <div class="invalid-feedback">
                                        Harus di isi
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="date" id="validationTooltip05" name="tanggal_perolehan"
                                        class="form-control" required value="{{old('tanggal_perolehan')}}">
                                    <div class="invalid-feedback">
                                        Harus di isi
                                    </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="asal_perolehans_id" id="validationTooltip06"
                                        aria-label="Default select example" value="{{old('asal_perolehans_id')}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="validationTooltip04" name="penanggung_jawab"
                                            class="form-control" required value="{{old('penanggung_jawab')}}">
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="validationTooltip04" name="ket"
                                            class="form-control"required value="{{old('ket')}}">
                                        <div class="invalid-feedback">
                                            Harus di isi
                                        </div>
                                    </div>
