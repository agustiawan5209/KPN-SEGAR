...
<head>
    ...
    <title>Edit akun admin- Sistem Inventaris dan Peminjaman Barang KPN “SEGAR” POLITEKNIK PELAYARAN BAROMBONG</title>
                                    ...
                                    <form class="row g-3 needs-validation" novalidate
                                        ...
                                        <div class="col-12">
                                            ...
                                            <input id="email" type="text"
                                                ...
                                                value="{{ $akun->username }}" required autocomplete="username">
                                            {{-- @error('email')
                          <span class="invalid-feedback" role="alert">
                              <strong>{{ $message }}</strong>
                          </span>
