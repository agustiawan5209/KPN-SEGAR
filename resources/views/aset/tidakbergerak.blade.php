                        ...
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{ asset('fotobarang/' . $data->foto) }}" style="width: 100px;"
                                            alt="...">
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-sm"
                                            style="background-color:  #012970; color:#FFFFFF" data-bs-toggle="modal"
                                                                    ...
                                                                    <div class="card-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-5 col-md-4 label">
                                                                                Tgl Perolehan</div>
                                                                            <div class="col-lg-7 col-md-8">
                                                                                <?php echo date('d F Y', strtotime($data->tanggal_perolehan)); ?>
                                                                            </div>
                                                                        </div>
