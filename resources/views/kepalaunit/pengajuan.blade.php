    ...
    <section class="section">
        <div class="row align-items-top">
            <div class="col-lg-14">
                ...
                <div class="card">
                    <div class="card-body p-0  overflow-scroll">
                        ...
                        <center>
                            <h5 style="align-content: center" class="card-title">Data Peminjaman</h5>
                            <center>


                                <!-- Table with stripped rows -->
                                <table class="table datatable overflow-hidden">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row">
                                            ...
                                            <td>
                                                ...
                                                @if ($waktu < 0) <p style="color:#cd0b30;" class="small fst-italic">
                                                    Sudah
                                                    Terlewat {{ -$waktu }}
                                                    hari</p>
                                                    @elseif($waktu > 0)
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm"
                                                    ...
                                                    data-bs-toggle="modal" data-bs-target="#modaldetail{{ $data->id }}">
                                                    <i class="bi bi-eye"></i>
                                                </button>
                                            ...
                                            <td>
                                                ...
                                                <?php $belumada_status = '<div class="badge bg-info btn-sm w-70 text-wrap dropdown-toggle ' . $data->kode_peminjaman . '" data-bs-toggle="modal" data-bs-target="#status' . $data->kode_peminjaman . '"id="#status' . $data->kode_peminjaman . '"> ' . $b->status . ' </div>'; ?>
                                                @elseif($a->status_id == $b->id && $b->id == 2)
                                                <?php $belumada_status = '<div class="badge bg-danger btn-sm w-70 text-wrap dropdown-toggle ' . $data->kode_peminjaman . '" data-bs-toggle="modal" data-bs-target="#status' . $data->kode_peminjaman . '"id="#status' . $data->kode_peminjaman . '"> ' . $b->status . ' </div>'; ?>
                                                @elseif($a->status_id == $b->id && $b->id == 3)
                                                <?php $belumada_status = '<div class="badge bg-warning btn-sm w-70 text-wrap dropdown-toggle ' . $data->kode_peminjaman . '" data-bs-toggle="modal" data-bs-target="#status' . $data->kode_peminjaman . '"id="#status' . $data->kode_peminjaman . '"> ' . $b->status . ' </div>'; ?>
                                                @elseif($a->status_id == $b->id && $b->id == 1)
                                                <?php $belumada_status = '<div class="badge bg-success btn-sm w-70 text-wrap dropdown-toggle ' . $data->kode_peminjaman . '" data-bs-toggle="modal" data-bs-target="#status' . $data->kode_peminjaman . '"id="#status' . $data->kode_peminjaman . '"> ' . $b->status . ' </div>'; ?>
                                                @elseif($a->status_id == $b->id && $b->id == 5)
                                                <?php $belumada_status = '<div class="badge bg-secondary btn-sm w-70 text-wrap dropdown-toggle ' . $data->kode_peminjaman . '" data-bs-toggle="modal" data-bs-target="#status' . $data->kode_peminjaman . '"id="#status' . $data->kode_peminjamans . '"> ' . $b->status . ' </div>'; ?>
                                                @endif
                                                @endforeach
                                                @endif
                                                @endforeach
                                                        ...
                                                        <div class="modal-content">
                                                                                    ...
                                                                                    <ul class="list-inline p-0 m-0">
                                                                                        ...
                                                                                        <li>
                                                                                            ...
                                                                                            <h6 style="color:#012970;"
                                                                                                class="d-inline-block w-50 text-wrap">
                                                                                                <b>
                                                                                                    {{ $item->status }}
                                                                                                </b>
                                                                                            </h6>
                                                            ...
                                                            {{-- <div class="activity">
                                                                ...
                                                                <div class="activity-item d-flex">
                                                                    ...
                                                                    <div @foreach ($status as $item) @if ($a->status_id
                                                                        == $item->id)
            ...
            <td>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="/insertstatus" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name="kode_peminjaman" value={{ $data->kode_peminjaman }}>
                ...
                @else
                <span class="badge border-dark border-1 text-dark small fst-italic text-wrap" style="color:#012970;">
                    sudah
                    diverifikasi</span>
                @endif
