                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body  overflow-scroll">
                            <h5 class="card-title">Laporan Data Mutasi</h5>

                            <form action="{{route('mutasi-filter-date')}}" method="post">
                                @csrf
                                <div class="row mb-3">
                    ...
                    @isset($data)
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="{{route('mutasi-cetak', ['startDate'=> $startDate, 'endDate'=> $endDate])}}"
