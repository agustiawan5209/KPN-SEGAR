    ...
    <main id="main" class="main overflow-hidden">
        <div class="card">
            <div class="card-body">
                ...
                <form id="form-formulir" action="{{ route('pinjamUang.update', ['id'=> $pinjam->id]) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-sm-10">
                            <select name="kode_anggota" id="" class="form-select">
                                ...
                                @foreach ($user as $anggota)
                                    <option value="{{ $anggota->kode_anggota }}" {{ $pinjam->kode_anggota == $anggota->kode_anggota ? 'selected' : '' }}>{{ $anggota->kode_anggota }} - @if ($anggota->user != null)
                                            {{ $anggota->user->name }}
                                        @endif
                                    </option>
                                @endforeach
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" id="validationTooltip02" name="jumlah_pinjam" id="jumlah_pinjam"
                                class="form-control jumlah_pinjam" required value="{{ $pinjam->jumlah_pinjam }}" placeholder="0000000000">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" id="tgl_pengajuan" name="tgl_pengajuan"
                                class="form-control" required value="{{ $pinjam->tgl_pengajuan }}">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="date" id="tgl_kembali" name="tgl_kembali" class="form-control" required value="{{ $pinjam->tgl_kembali }}">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="bunga" name="bunga" class="form-control bunga" required value="{{ $pinjam->bunga }}">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="file" id="datefield2" name="bukti_pinjam" class="form-control" value="{{ $pinjam->bukti_pinjam }}">
                    ...
                    {{-- <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="number" id="jumlah_angsuran" name="jumlah_angsuran" class="form-control" required value="{{ $pinjam->angsuran->count() }}">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" id="datefield2" name="ket" class="form-control" required value="{{ $pinjam->ket }}">
                            <div class="invalid-feedback">
                                Harus di isi
                            </div>
                        </div>
