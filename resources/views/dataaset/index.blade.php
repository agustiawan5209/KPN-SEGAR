...
<main id="main" class="main">
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body"> --}}
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Data Riwayat Peminjaman
                                                                        </h5>
                                                                        ...
                                                                        <table class="table datatable">
                                                                            <thead>
                                                                                <tr>
                                                                                    <th scope="col">No</th>
                                                                                    <th scope="col">Nama Peminjaman
                                                                                    </th>
                                                                                    <th scope="col">jenis peminjaman
                                                                                    </th>
                                                                                    <th scope="col">Tanggal
                                                                                        Pengajuan</th>
                                                                                    {{-- <th scope="col">Tanggal Peminjaman</th> --}}
                                                                                    <th scope="col">Tanggal Kembali
                                                                                    </th>
                                                                                </tr>
                                                                            </thead>
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="">
                                                                                        {{ $item->tgl_pengajuan }}</td>
                                                                                    {{-- <td class="">{{ $item->tgl_pinjam }}</td> --}}
                                                                                    <td class="">
                                                                                        {{ $item->tgl_kembali }}</td>
                                                                                </tr>
    ...
    <a href="/data-aset/hapusdataaset/{{ $data->id }}" onclick="return confirm('Hapus Data?')" type="button"
