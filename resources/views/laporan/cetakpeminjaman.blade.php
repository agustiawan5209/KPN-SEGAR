                    ...
                    <tbody>
                        ...
                        @foreach ($data as $data)
                            <tr>
                                ...
                                <td style="text-align: center;"> {{ $data->kode_peminjaman }}</td>
                                <td style="text-align: center;"> {{ $data->nama_peminjam }}</td>
                                <td style="text-align: center;"> {{ $data->jenis_peminjaman }}</td>
                                <td style="text-align: center;"> {{ $data->tgl_pengajuan }}</td>
